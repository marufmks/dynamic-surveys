 ...
 * Plugin URI:        https://github.com/marufmks/dynamic-survey
...
function ds_frontend_scripts() {
    ...
    wp_enqueue_script('ds-frontend-script', DS_PLUGIN_URL . 'assets/js/frontend.js', array('jquery', 'chart-js'), DS_VERSION, true);
